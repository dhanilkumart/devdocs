    ...
    <div ref={wrapRef} className="relative w-full max-w-xl">
      ...
      <div className="relative">
        ...
        <input
          ...
          onKeyDown={onKeyDown}
          className="w-full rounded-xl border border-zinc-200 bg-white py-2.5 pl-9 pr-10 text-sm text-zinc-900 shadow-sm outline-none ring-sky-500/40 placeholder:text-zinc-400 focus:border-sky-500 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-500"
        />
        <button
          type="button"
